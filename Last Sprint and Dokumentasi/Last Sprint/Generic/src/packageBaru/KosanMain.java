...
public class KosanMain {	
    public static void main(String[] args) {
        ...
        System.out.println("7. Aturan Air");
        System.out.println("8. Keluar");
        System.out.println("=====================================");
        System.out.print("Pilihan [1/2/3/4/5/6/7/8] = ");
		...
		System.out.println("======================== GENERIC PROGRAM =======================");
            ...
            case 7:{
		System.out.println("=================== METHOD GENERIC PROGRAM =====================");
                
                Sprint1 <String> lat1 = new Sprint1 <> ();
                Sprint1.printNama("Taofik Rakhman");
                Sprint1.printRuang("Ruang Atas No 3");
                Sprint1.printJadwal("Selasa","Minggu");
                
                Sprint2 <String> lat2 = new Sprint2 <> ();
                lat2.setTipe("HARGA AIR DAN ATURAN");
                System.out.println(lat2.getTipe());
                
                Sprint2.printAturan("AIR DISINI BEBAS PAKAI, IURAN BULANAN DIBAGI RATA");
                System.out.println("HARGA IURAN BULANAN --> ");Sprint2.printNilai(50000);
                lat2.methodKonkrit();
                break;
            }
            case 8:{
